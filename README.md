...
**Current release:** [Bytefray v1.1.0](https://github.com/libertaine/Bytefray/releases/tag/v1.1.0).
...
|------|------|--------------|
| 🧰 **Windows installer** | [Bytefray-Setup-1.1.0.exe](https://github.com/libertaine/Bytefray/releases/download/v1.1.0/Bytefray-Setup-1.1.0.exe) | Installs under `C:\Program Files\Bytefray` |
| 💼 **Portable Windows applications** | [bytefray-1.1.0-windows.zip](https://github.com/libertaine/Bytefray/releases/download/v1.1.0/bytefray-1.1.0-windows.zip) | Complete onedir layouts for all four executables |
| 🐍 **Python wheel** | [bytefray-1.1.0-py3-none-any.whl](https://github.com/libertaine/Bytefray/releases/download/v1.1.0/bytefray-1.1.0-py3-none-any.whl) | Pure Python 3.10–3.13 package; does not contain pMARS |
| 🔐 **Checksums** | [SHA256SUMS.txt](https://github.com/libertaine/Bytefray/releases/download/v1.1.0/SHA256SUMS.txt) | SHA-256 values for release assets |
