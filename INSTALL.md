...
Download `Bytefray-Setup-0.9.0.exe` from the
[v0.9.0 release](https://github.com/libertaine/Bytefray/releases/tag/v0.9.0)
...
application trees is `bytefray-0.9.0-windows.zip`. Extract the entire ZIP
