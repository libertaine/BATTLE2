...
Download `Bytefray-Setup-1.4.1.exe` from the
[v1.4.1 release](https://github.com/libertaine/Bytefray/releases/tag/v1.4.1)
...
application trees is `bytefray-1.4.1-windows.zip`. Extract the entire ZIP
...
Download `bytefray-1.4.1-windows.zip` from the release (see
...
python -m pip install .\bytefray-1.4.1-py3-none-any.whl
bytefray --help
```
