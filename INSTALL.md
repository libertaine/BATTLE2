...
Download `Bytefray-Setup-1.5.0.exe` from the
[v1.5.0 release](https://github.com/libertaine/Bytefray/releases/tag/v1.5.0)
...
application trees is `bytefray-1.5.0-windows.zip`. Extract the entire ZIP
...
Download `bytefray-1.5.0-windows.zip` from the release (see
...
python -m pip install .\bytefray-1.5.0-py3-none-any.whl
bytefray --help
```
