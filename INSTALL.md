...
Download `Bytefray-Setup-0.10.0.exe` from the
[v0.10.0 release](https://github.com/libertaine/Bytefray/releases/tag/v0.10.0)
...
application trees is `bytefray-0.10.0-windows.zip`. Extract the entire ZIP
...
Download `bytefray-0.10.0-windows.zip` from the release (see
...
python -m pip install .\bytefray-0.10.0-py3-none-any.whl
bytefray --help
```
