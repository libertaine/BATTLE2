...
; "v1.5.0" Git tag/GitHub release name) while AppVersion keeps the PEP 440
; spelling used by the Python package/CLI. Both spellings are identical for
; a final release ("1.5.0"); ReleaseTag is kept as its own define (rather
